...
- Tables - Include a table ( <table> ) element with at least 2 rows.
	- While I was trying to get around using a table by sizing down a few <div>'s and orienting them to sit side by side, I opted to add the table to my searchResults page for now. 
